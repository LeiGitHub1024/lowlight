...
from losses import CharbonnierLoss,MyLoss,SSIM,SSIMLoss,TVLoss
...
stage0_checkpoint = './log/Uformer32_1006_1_0/models/model_best.pth'
...
for epoch in range(start_epoch, opt.nepoch + 1):
    ...
    for i, data in enumerate(train_loader, 0): 
        ...
        with torch.cuda.amp.autocast():
            ...
            loss0 = criterion0(reflex, mid, epoch) + criterion1(reflex)
            loss1 = criterion2(restored, target, epoch)
