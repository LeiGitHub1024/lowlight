...
python3 ./train_0.py --arch Uformer --batch_size 32 --gpu '0' \
    --train_ps 64 --train_dir /home/mist/lowlight/datasets/lol_stage0/train --env 32_1006_1_0 \
...
nohup python3 ./train_1.py --arch Uformer --batch_size 16 --gpu '0' \
    --train_ps 64 --train_dir /home/mist/lowlight/datasets/lol_stage1/train --env 32_1006_1_1 \
