...
parser.add_argument('--input_dir', default='/home/mist/lowlight/datasets/mit500/test_256',type=str, help='Directory of validation images')
parser.add_argument('--result_dir', default='./log/Uformer32_1008_1_1/results_mit_mid/',type=str, help='Directory for results')
parser.add_argument('--weights', default='./log/Uformer32_1008_1_1/models/model_best.pth',type=str, help='Path to weights')
...
with torch.no_grad():
    ...
    for ii, data_test in enumerate(tqdm(test_loader), 0):
        ...
        if stage == 1:
            tmp, rgb_restored = model_restoration(rgb_noisy, 1)
        else:
            rgb_restored = model_restoration(rgb_noisy, 0)
