...
parser.add_argument('--result_dir', default='./log/Uformer32_1009_1_0/results_mit/',type=str, help='Directory for results')
parser.add_argument('--weights', default='./log/Uformer32_1009_1_0/models/model_best.pth',type=str, help='Path to weights')
