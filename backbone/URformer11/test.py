...
parser.add_argument('--input_dir', default='/home/mist/lowlight/datasets/lol/test',type=str, help='Directory of validation images')
parser.add_argument('--result_dir', default='./log/Uformer32_1018_1_0/results/',type=str, help='Directory for results')
parser.add_argument('--weights', default='./log/Uformer32_1018_1_0/models/model_best.pth',type=str, help='Path to weights')
