...
parser.add_argument('--input_dir', default='/home/mist/low-light/datasets/LOL/test',type=str, help='Directory of validation images')
parser.add_argument('--result_dir', default='./result_lol',type=str, help='Directory for results')
parser.add_argument('--weights', default='./models/model_epoch_100.pth',type=str, help='Path to weights')
