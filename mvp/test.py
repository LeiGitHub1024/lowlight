...
parser.add_argument('--result_dir', default='./log/Uformer32_1005_l1_200/results_l1_200/',type=str, help='Directory for results')
parser.add_argument('--weights', default='./log/Uformer32_1005_l1_200/models/l1_200.pth',type=str, help='Path to weights')
