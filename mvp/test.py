...
parser.add_argument('--result_dir', default='./log/Uformer1028_ps256_ssim_lol/results/ain1',type=str, help='Directory for results')
parser.add_argument('--weights', default='./log/Uformer1028_ps256_ssim_lol/models/model_latest.pth',type=str, help='Path to weights')
