...
nohup python3 ./train.py --arch Uformer --batch_size 48 --gpu '0' \
    --train_ps 128 --train_dir ../datasets/mbllen/train --env 1011_mbllen_up \
    --val_dir ../datasets/mbllen/valid --embed_dim 32 --warmup  --nepoch=500 --lr_initial=0.0001 --resume --pretrain_weights './log/Uformer1011_mbllen_up/models/model_latest.pth' &
    # --optimizer adam
